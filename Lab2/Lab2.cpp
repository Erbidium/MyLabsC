				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							side1=round(sqrt(pow(x1-x2, 2)+pow(y1-y2, 2))*1000)/1000;
							side2=round(sqrt(pow(x1-x3, 2)+pow(y1-y3, 2))*1000)/1000;
							side3=round(sqrt(pow(x2-x3, 2)+pow(y2-y3, 2))*1000)/1000;
